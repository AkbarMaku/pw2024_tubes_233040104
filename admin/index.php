    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          ...
          <li>
            <div class="dropdown">
              <button class="btn btn-bg-transparent dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                Admin
              </button>
              <ul class="dropdown-menu">
                <li><a href="daftar-admin.php" class="dropdown-item" type="button">Daftar admin</a></li>
                <li><a href="../login/regis.php" class="dropdown-item" type="button">Registrasi admin</a></li>
              </ul>
            </div>
          </li>
        </ul>
